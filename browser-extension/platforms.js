globalThis.StoryForgePlatforms = {
  ...
  xiaohongshu: {
    label: '小红书',
    mark: '红',
    uploadUrl: 'https://creator.xiaohongshu.com/publish/publish?source=storyforge'
  },
  baijiahao: {
    label: '百家号',
    mark: '百',
    uploadUrl: 'https://baijiahao.baidu.com/builder/rc/home'
  }
};

globalThis.StoryForgePlatforms.openUrl = (platform, taskId) => {
  const target = new URL(globalThis.StoryForgePlatforms[platform].uploadUrl);
  target.searchParams.set('storyforge_task', taskId);
  return target.href;
};
