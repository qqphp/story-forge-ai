...
function CreateDialog({ connected, onClose, onSubmit }: { connected: boolean; onClose: () => void; onSubmit: (data: Record<string, unknown>) => Promise<void> }) {
  ...
  const [music,setMusic]=useState<BackgroundMusic[]>([]); const [musicId,setMusicId]=useState(""); const [musicVolume,setMusicVolume]=useState(20); const [fadeIn,setFadeIn]=useState(2); const [fadeOut,setFadeOut]=useState(2);
