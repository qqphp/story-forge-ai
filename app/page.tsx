...
type PublishTask = { id:string; workflow_id:string; book_title:string; platform:"douyin"; status:string; title:string; description:string; tags:string[]; topics:string[]; video_url:string; cover_url:string; covers:Asset[]; created_at:number; updated_at:number; error:string };
...
export default function Home() {
  ...
  return (
    <main className="app-shell">
      ...
      {activePage==="publish"&&<PublishCenterPage connected={connected} workflows={tasks} onToast={setToast}/>}
